...
export interface CallContractHookBlockProps {
  value?: {
    address: string;
    functionName: string;
    callData: string;
  ...
  onChange?: (value: CallContractHookBlockProps['value']) => void;
}

const CallContractHookBlock: React.FC<CallContractHookBlockProps> = ({
  value = { address: '', functionName: '', callData: '', returnOption: 'none' },
  onChange,
}) => {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontWeight: 700, fontSize: '1.1em', marginBottom: 6 }}>Call Contract</div>
...
export default CallContractHookBlock;